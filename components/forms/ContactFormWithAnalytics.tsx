...
export default function ContactFormWithAnalytics() {
  ...
  const handlePhoneClick = () => {
    trackPhoneCall('+1-833-874-1019', 'contact_cta')
    window.location.href = 'tel:+18338741019'
  }

  const handleEmailClick = () => {
    trackEmailClick('info@nexttripanywhere.com', 'contact_cta')
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8">
      ...
      <div className="text-center mb-10">
        <h2 className="text-4xl font-bold text-gray-900 mb-4">Get Your Free Travel Quote</h2>
        <p className="text-lg text-gray-600 mb-2">
          Let our expert travel agents create the perfect itinerary for your dream vacation
        </p>
      ...
      <div className="mb-10">
        ...
        <p className="text-center text-sm text-gray-500 mt-3">
          Click to fill out our quick travel quote form
        </p>
      </div>
