...
export const destinationGuides: DestinationGuide[] = [
...

  {
    ...
    metaDescription:
      'Complete Nassau travel guide for Essex County residents. Direct flights from Newark, best beaches, Paradise Island, shore excursions, and local tips.',
    keywords: [
      'Nassau Bahamas',
      'Nassau from Newark',
      'Paradise Island',
    ...
    content: {
      ...
      gettingThereFromEssexCounty: {
        overview:
          'Nassau is one of the most accessible Caribbean destinations from Essex County, with multiple daily direct flights from Newark Liberty International Airport. The short flight time of just under 3 hours makes it perfect for both long weekends and extended vacations.',
        flightOptions: [
      ...
      topAttractions: [
        {
          ...
          description:
            "This iconic resort complex features the world's largest open-air marine habitat, thrilling water slides at Aquaventure, and a variety of restaurants and casinos. Day passes are available for non-guests.",
          mustSee: true,
          duration: 'Full day',
        ...
        },
        {
          ...
          description:
            'These 65 steps were carved out of solid limestone by slaves in the late 18th century. The staircase is surrounded by tropical plants and offers a cool respite from the heat.',
          mustSee: true,
        ...
        },
        {
          ...
          description:
            'The authentic Bahamian marketplace where local artisans sell handmade straw goods, wood carvings, and souvenirs. Perfect for finding unique gifts to bring back to Essex County.',
          mustSee: true,
          duration: '1-2 hours',
        ...
        },
        {
          name: 'Fort Fincastle',
          description:
            "Built in 1793, this fort offers panoramic views of Nassau harbor and Paradise Island. Its unique paddle-wheel steamer shape makes it one of Nassau's most photographed landmarks.",
          mustSee: false,
          duration: '45 minutes',
          cost: '$5 admission',
        },
        {
          ...
          description:
            'Home to the famous marching flamingos, this 5-acre garden features over 300 animals and tropical plants. The flamingo show happens three times daily.',
          mustSee: false,
          duration: '2 hours',
          cost: '$18 adults',
        },
      ...
      shoreExcursions: {
        cruiseLine: [
          {
            ...
            description:
              'Visit the famous swimming pigs of Exuma on this full-day adventure including lunch and snorkeling',
            duration: '8 hours',
          ...
          },
          {
            ...
            description:
              'Full access to water park, beaches, and marine exhibits at Atlantis Resort',
            duration: '6 hours',
        ...
        independent: [
          ...
          },
          {
            ...
            description:
              'Public beach within walking distance of cruise port with restaurants and rentals',
            duration: 'Flexible',
        ...
        beaches: [
          {
            name: 'Cable Beach',
            description:
              "Nassau's premier beach stretching 2.5 miles with white sand and calm waters. Home to major resorts but public access available.",
          ...
          },
          {
            name: 'Junkanoo Beach',
            description:
              'Popular public beach within walking distance of cruise port. Lively atmosphere with beach bars and local food vendors.',
          ...
          },
          {
            name: 'Paradise Beach',
            description:
              'Located on Paradise Island, this pristine beach offers calm, shallow waters perfect for swimming and snorkeling.',
          ...
          },
          {
            name: 'Love Beach',
            description:
              'Quieter beach on the northwestern shore, popular with locals and perfect for sunset viewing.',
        ...
        shoppingAreas: [
          {
            name: 'Bay Street',
            description:
              "Nassau's main shopping street with duty-free stores, luxury brands, and local shops. Best for jewelry, perfumes, and designer goods.",
            whatToBuy: [
              'Duty-free jewelry',
              'Perfumes',
              'Watches',
          ...
          },
          {
            name: 'Nassau Straw Market',
            description:
              'Authentic Bahamian marketplace with handmade crafts and souvenirs. Great for unique gifts and local art.',
          ...
          },
          {
            ...
            description:
              'Upscale shopping village with boutiques, galleries, and restaurants overlooking the marina.',
        ...
        historicalSites: [
          {
            name: 'Fort Charlotte',
            description:
              'Largest fort in Nassau built in 1789 with dungeons, drawbridge, and cannons',
      ...
      practicalInformation: {
        ...
        transportation: {
          ...
          taxiInfo:
            'Fixed rates posted at airport and cruise port. Agree on fare before starting trip.',
          publicTransport: 'Jitneys run on major routes 6 AM - 7 PM. No service Sundays.',
          rentalCars:
            "International driver's license recommended. Minimum age 25 at most agencies.",
        },
        safety: {
          general:
            'Nassau is generally safe for tourists who stick to main areas and use common sense. Avoid displaying wealth.',
          areas: {
            safe: ['Paradise Island', 'Cable Beach', 'Downtown tourist area', 'Atlantis resort'],
            caution: [
              'Over-the-Hill area south of downtown',
      ...
      bestTimeToVisit: {
        overview:
          "Nassau enjoys warm weather year-round with temperatures rarely dropping below 70°F. The best time for Essex County travelers is December through April when the weather is perfect and you'll escape the New Jersey winter.",
        peakSeason: {
        ...
        weather: {
          ...
          hurricaneSeason:
            'June 1 - November 30, with peak activity August-October. Travel insurance recommended.',
        },
      },
    },
    faqs: [
      {
        ...
        answer:
          "Yes, all US citizens need a valid passport to enter the Bahamas. Your passport should be valid for at least 6 months from your travel date. New Jersey residents can renew passports at Essex County Clerk's Office in Newark.",
      },
      {
        question: "What's the best way to get from Newark Airport to Nassau?",
        answer:
          'United Airlines offers the most frequent direct flights from Newark (EWR) to Nassau (NAS), with 2-3 daily flights taking just under 3 hours. Book 6-8 weeks in advance for best prices, typically $300-500 round trip.',
      },
      {
        question: 'Is Nassau safe for tourists from New Jersey?',
        answer:
          "Nassau is generally safe for tourists who stay in main tourist areas like Paradise Island, Cable Beach, and downtown. Use the same street smarts you'd use in Newark or Jersey City. Avoid isolated areas after dark and don't display expensive jewelry.",
      },
      {
        question: 'Can I use US dollars in Nassau?',
        answer:
          "Yes! US dollars are accepted everywhere in Nassau at a 1:1 exchange rate with the Bahamian dollar. You'll likely receive Bahamian dollars as change, which you can use interchangeably. Credit cards are also widely accepted.",
      },
      {
        question: "What's the weather like compared to New Jersey?",
        answer:
          "Nassau is significantly warmer than Essex County year-round. When it's 30°F in Newark in January, it's 75°F in Nassau. Summer temperatures are similar (85-90°F) but Nassau has higher humidity and afternoon rain showers.",
      },
    ],
    conclusion:
      "Nassau offers Essex County travelers the perfect Caribbean escape with easy access from Newark Airport, world-class beaches, and endless activities. Whether you're sailing from Cape Liberty on a cruise or flying direct from EWR, this tropical paradise provides year-round sunshine just 3 hours from home. With its combination of relaxation, adventure, and rich culture, Nassau remains one of the most popular destinations for New Jersey travelers seeking an unforgettable island getaway. Call 833-874-1019 to start planning your Nassau vacation today.",
    internalLinks: [
      '/cruises/bahamas',
      '/cruises/from-newark',
...
export function getRelatedGuides(currentSlug: string, limit = 3): DestinationGuide[] {
  ...
  return destinationGuides
    .filter((guide) => guide.slug !== currentSlug && guide.region === currentGuide.region)
    .slice(0, limit)
}
...
export function getGuidesForSitemap() {
  return destinationGuides.map((guide) => ({
    ...
    changeFrequency: (guide.priority === 'HIGH' ? 'weekly' : 'monthly') as 'weekly' | 'monthly',
