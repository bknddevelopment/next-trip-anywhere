/**
 * Belleville Special Events Service Page
...
export const metadata: Metadata = {
  title: `Special Events in Belleville, NJ | Next Trip Anywhere`,
  description: `Reliable special events for Belleville and surrounding areas. Transportation for concerts, sporting events, proms, and special occasions throughout the tri-state area. Available 24/7 at 833-874-1019.`,
  keywords: [
    `special-events Belleville`,
    `Belleville special events`,
    ...['special events', 'concert transportation', 'sports events', 'prom limo', 'event shuttle'],
    `Belleville NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-belleville/special-events`,
  },
  openGraph: {
    title: `Special Events in Belleville | Next Trip Anywhere`,
    description: `Professional special events for Belleville residents. Transportation for concerts, sporting events, proms, and special occasions throughout the tri-state area.`,
    url: `https://nexttripanywhere.com/travel-from-belleville/special-events`,
    type: 'website',
    locale: 'en_US',
...
export default function BellevilleSpecialEventsPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Serving Belleville with premium special events solutions since 2010.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Special Events for Belleville Residents</h2>
            <div className="prose max-w-none">
              <p>
                Serving Belleville with premium special events solutions since 2010. With a
