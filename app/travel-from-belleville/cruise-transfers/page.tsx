/**
 * Belleville Cruise Transfers Service Page
...
export const metadata: Metadata = {
  title: `Cruise Transfers in Belleville, NJ | Next Trip Anywhere`,
  description: `Reliable cruise transfers for Belleville and surrounding areas. Direct transfers to Manhattan, Brooklyn, and Cape Liberty cruise terminals with luggage assistance. Available 24/7 at 833-874-1019.`,
  keywords: [
    `cruise-transfers Belleville`,
    `Belleville cruise transfers`,
    ...[
      'cruise transfers',
      'port transportation',
      'cruise terminal',
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-belleville/cruise-transfers`,
  },
  openGraph: {
    title: `Cruise Transfers in Belleville | Next Trip Anywhere`,
    description: `Professional cruise transfers for Belleville residents. Direct transfers to Manhattan, Brooklyn, and Cape Liberty cruise terminals with luggage assistance.`,
    url: `https://nexttripanywhere.com/travel-from-belleville/cruise-transfers`,
    type: 'website',
    locale: 'en_US',
...
export default function BellevilleCruiseTransfersPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Professional cruise transfers services tailored for Belleville residents and businesses.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Cruise Transfers for Belleville Residents</h2>
            <div className="prose max-w-none">
              <p>
                Professional cruise transfers services tailored for Belleville residents and
