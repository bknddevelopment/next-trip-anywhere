/**
 * Belleville Wedding Transportation Service Page
...
export const metadata: Metadata = {
  title: `Wedding Transportation in Belleville, NJ | Next Trip Anywhere`,
  description: `Reliable wedding transportation for Belleville and surrounding areas. Elegant wedding transportation including limousines, party buses, and guest shuttle services. Available 24/7 at 833-874-1019.`,
  keywords: [
    `wedding-transportation Belleville`,
    `Belleville wedding transportation`,
    ...['wedding transportation', 'wedding limo', 'bridal party', 'guest shuttle', 'wedding cars'],
    `Belleville NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-belleville/wedding-transportation`,
  },
  openGraph: {
    title: `Wedding Transportation in Belleville | Next Trip Anywhere`,
    description: `Professional wedding transportation for Belleville residents. Elegant wedding transportation including limousines, party buses, and guest shuttle services.`,
    url: `https://nexttripanywhere.com/travel-from-belleville/wedding-transportation`,
    type: 'website',
    locale: 'en_US',
...
export default function BellevilleWeddingTransportationPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Professional wedding transportation services tailored for Belleville residents and businesses.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">
              Wedding Transportation for Belleville Residents
            </h2>
            <div className="prose max-w-none">
              <p>
                Professional wedding transportation services tailored for Belleville residents and
                businesses. With a population of 38,222, Belleville residents trust Next Trip
