/**
 * Belleville School Transportation Service Page
...
export const metadata: Metadata = {
  title: `School Transportation in Belleville, NJ | Next Trip Anywhere`,
  description: `Reliable school transportation for Belleville and surrounding areas. Safe student transportation for field trips, sports events, and daily school runs with certified drivers. Available 24/7 at 833-874-1019.`,
  keywords: [
    `school-transportation Belleville`,
    `Belleville school transportation`,
    ...[
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-belleville/school-transportation`,
  },
  openGraph: {
    title: `School Transportation in Belleville | Next Trip Anywhere`,
    description: `Professional school transportation for Belleville residents. Safe student transportation for field trips, sports events, and daily school runs with certified drivers.`,
    url: `https://nexttripanywhere.com/travel-from-belleville/school-transportation`,
    type: 'website',
    locale: 'en_US',
...
export default function BellevilleSchoolTransportationPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Your trusted school transportation provider in Belleville and Essex County.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">
              School Transportation for Belleville Residents
            </h2>
            <div className="prose max-w-none">
              <p>
                Your trusted school transportation provider in Belleville and Essex County. With a
