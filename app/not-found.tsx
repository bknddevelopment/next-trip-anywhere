...
export default function NotFound() {
  ...
  useEffect(() => {
    if (pathname) {
      ...
      const cleaned = lastSegment?.replace(/-/g, ' ').replace(/%20/g, ' ').toLowerCase()
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-blue-50 to-white px-4 py-16">
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {popularPages.map((page) => (
              ...
              >
                <span className="text-blue-600 hover:text-blue-800 font-medium">{page.label}</span>
              </Link>
            ))}
          </div>
        </div>
        ...
        <div className="border-t pt-8">
          <p className="text-gray-600 mb-4">Need help? Our travel experts are here for you.</p>
