/**
 * Fairfield Cruise Transfers Service Page
...
export const metadata: Metadata = {
  title: `Cruise Transfers in Fairfield, NJ | Next Trip Anywhere`,
  description: `Cruise Transfers in Fairfield, NJ - Next Trip Anywhere provides direct transfers to manhattan, brooklyn, and cape liberty cruise terminals with luggage assistance. Serving Essex County with excellence.`,
  keywords: [
    `cruise-transfers Fairfield`,
    `Fairfield cruise transfers`,
    ...[
      'cruise transfers',
      'port transportation',
      'cruise terminal',
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-fairfield/cruise-transfers`,
  },
  openGraph: {
    title: `Cruise Transfers in Fairfield | Next Trip Anywhere`,
    description: `Professional cruise transfers for Fairfield residents. Direct transfers to Manhattan, Brooklyn, and Cape Liberty cruise terminals with luggage assistance.`,
    url: `https://nexttripanywhere.com/travel-from-fairfield/cruise-transfers`,
    type: 'website',
    locale: 'en_US',
...
export default function FairfieldCruiseTransfersPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Your trusted cruise transfers provider in Fairfield and Essex County.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Cruise Transfers for Fairfield Residents</h2>
            <div className="prose max-w-none">
              <p>
                Your trusted cruise transfers provider in Fairfield and Essex County. With a
