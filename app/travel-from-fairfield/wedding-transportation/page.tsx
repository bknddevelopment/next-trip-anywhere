/**
 * Fairfield Wedding Transportation Service Page
...
export const metadata: Metadata = {
  title: `Wedding Transportation in Fairfield, NJ | Next Trip Anywhere`,
  description: `Wedding Transportation in Fairfield, NJ - Next Trip Anywhere provides elegant wedding transportation including limousines, party buses, and guest shuttle services. Serving Essex County with excellence.`,
  keywords: [
    `wedding-transportation Fairfield`,
    `Fairfield wedding transportation`,
    ...['wedding transportation', 'wedding limo', 'bridal party', 'guest shuttle', 'wedding cars'],
    `Fairfield NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-fairfield/wedding-transportation`,
  },
  openGraph: {
    title: `Wedding Transportation in Fairfield | Next Trip Anywhere`,
    description: `Professional wedding transportation for Fairfield residents. Elegant wedding transportation including limousines, party buses, and guest shuttle services.`,
    url: `https://nexttripanywhere.com/travel-from-fairfield/wedding-transportation`,
    type: 'website',
    locale: 'en_US',
...
export default function FairfieldWeddingTransportationPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Your trusted wedding transportation provider in Fairfield and Essex County.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">
              Wedding Transportation for Fairfield Residents
            </h2>
            <div className="prose max-w-none">
              <p>
                Your trusted wedding transportation provider in Fairfield and Essex County. With a
