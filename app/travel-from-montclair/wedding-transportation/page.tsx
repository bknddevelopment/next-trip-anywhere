/**
 * Montclair Wedding Transportation Service Page
...
export const metadata: Metadata = {
  title: `Wedding Transportation in Montclair, NJ | Next Trip Anywhere`,
  description: `Elegant wedding transportation including limousines, party buses, and guest shuttle services. Serving Montclair and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `wedding-transportation Montclair`,
    `Montclair wedding transportation`,
    ...['wedding transportation', 'wedding limo', 'bridal party', 'guest shuttle', 'wedding cars'],
    `Montclair NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-montclair/wedding-transportation`,
  },
  openGraph: {
    title: `Wedding Transportation in Montclair | Next Trip Anywhere`,
    description: `Professional wedding transportation for Montclair residents. Elegant wedding transportation including limousines, party buses, and guest shuttle services.`,
    url: `https://nexttripanywhere.com/travel-from-montclair/wedding-transportation`,
    type: 'website',
    locale: 'en_US',
...
export default function MontclairWeddingTransportationPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Elegant wedding transportation services for Montclair couples and wedding parties.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">
              Wedding Transportation for Montclair Residents
            </h2>
            <div className="prose max-w-none">
              <p>
                Elegant wedding transportation services for Montclair couples and wedding parties.
                With a population of 40,921, Montclair residents trust Next Trip Anywhere for
