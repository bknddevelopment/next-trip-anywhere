/**
 * Montclair Group Travel Service Page
...
export const metadata: Metadata = {
  title: `Group Travel in Montclair, NJ | Next Trip Anywhere`,
  description: `Group Travel in Montclair, NJ - Next Trip Anywhere provides professional group travel coordination for schools, churches, sports teams, and organizations. Serving Essex County with excellence.`,
  keywords: [
    `group-travel Montclair`,
    `Montclair group travel`,
    ...['group travel', 'organization trips', 'school travel', 'church groups', 'sports teams'],
    `Montclair NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-montclair/group-travel`,
  },
  openGraph: {
    title: `Group Travel in Montclair | Next Trip Anywhere`,
    description: `Professional group travel for Montclair residents. Professional group travel coordination for schools, churches, sports teams, and organizations.`,
    url: `https://nexttripanywhere.com/travel-from-montclair/group-travel`,
    type: 'website',
    locale: 'en_US',
...
export default function MontclairGroupTravelPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Serving Montclair with premium group travel solutions since 2010.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Group Travel for Montclair Residents</h2>
            <div className="prose max-w-none">
              <p>
                Serving Montclair with premium group travel solutions since 2010. With a population
                of 40,921, Montclair residents trust Next Trip Anywhere for reliable group travel
                services.
              </p>
