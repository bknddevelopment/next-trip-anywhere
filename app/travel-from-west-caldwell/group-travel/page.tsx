/**
 * West Caldwell Group Travel Service Page
...
export const metadata: Metadata = {
  title: `Group Travel in West Caldwell, NJ | Next Trip Anywhere`,
  description: `Professional group travel services for West Caldwell residents. Professional group travel coordination for schools, churches, sports teams, and organizations. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `group-travel West Caldwell`,
    `West Caldwell group travel`,
    ...['group travel', 'organization trips', 'school travel', 'church groups', 'sports teams'],
    `West Caldwell NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-west-caldwell/group-travel`,
  },
  openGraph: {
    title: `Group Travel in West Caldwell | Next Trip Anywhere`,
    description: `Professional group travel for West Caldwell residents. Professional group travel coordination for schools, churches, sports teams, and organizations.`,
    url: `https://nexttripanywhere.com/travel-from-west-caldwell/group-travel`,
    type: 'website',
    locale: 'en_US',
...
export default function WestCaldwellGroupTravelPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Professional group travel services tailored for West Caldwell residents and businesses.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Group Travel for West Caldwell Residents</h2>
            <div className="prose max-w-none">
              <p>
                Professional group travel services tailored for West Caldwell residents and
