/**
 * West Caldwell Cruise Transfers Service Page
...
export const metadata: Metadata = {
  title: `Cruise Transfers in West Caldwell, NJ | Next Trip Anywhere`,
  description: `Professional cruise transfers services for West Caldwell residents. Direct transfers to Manhattan, Brooklyn, and Cape Liberty cruise terminals with luggage assistance. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `cruise-transfers West Caldwell`,
    `West Caldwell cruise transfers`,
    ...[
      'cruise transfers',
      'port transportation',
      'cruise terminal',
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-west-caldwell/cruise-transfers`,
  },
  openGraph: {
    title: `Cruise Transfers in West Caldwell | Next Trip Anywhere`,
    description: `Professional cruise transfers for West Caldwell residents. Direct transfers to Manhattan, Brooklyn, and Cape Liberty cruise terminals with luggage assistance.`,
    url: `https://nexttripanywhere.com/travel-from-west-caldwell/cruise-transfers`,
    type: 'website',
    locale: 'en_US',
...
export default function WestCaldwellCruiseTransfersPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Serving West Caldwell with premium cruise transfers solutions since 2010.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">
              Cruise Transfers for West Caldwell Residents
            </h2>
            <div className="prose max-w-none">
              <p>
                Serving West Caldwell with premium cruise transfers solutions since 2010. With a
