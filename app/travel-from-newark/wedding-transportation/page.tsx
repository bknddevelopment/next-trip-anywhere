/**
 * Newark Wedding Transportation Service Page
...
export const metadata: Metadata = {
  title: `Wedding Transportation in Newark, NJ | Next Trip Anywhere`,
  description: `Elegant wedding transportation including limousines, party buses, and guest shuttle services. Serving Newark and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `wedding-transportation Newark`,
    `Newark wedding transportation`,
    ...['wedding transportation', 'wedding limo', 'bridal party', 'guest shuttle', 'wedding cars'],
    `Newark NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-newark/wedding-transportation`,
  },
  openGraph: {
    title: `Wedding Transportation in Newark | Next Trip Anywhere`,
    description: `Professional wedding transportation for Newark residents. Elegant wedding transportation including limousines, party buses, and guest shuttle services.`,
    url: `https://nexttripanywhere.com/travel-from-newark/wedding-transportation`,
    type: 'website',
    locale: 'en_US',
...
export default function NewarkWeddingTransportationPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Elegant wedding transportation services for Newark couples and wedding parties.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Wedding Transportation for Newark Residents</h2>
            <div className="prose max-w-none">
              <p>
                Elegant wedding transportation services for Newark couples and wedding parties. With
                a population of 311,549, Newark residents trust Next Trip Anywhere for reliable
