/**
 * Newark Group Travel Service Page
...
export const metadata: Metadata = {
  title: `Group Travel in Newark, NJ | Next Trip Anywhere`,
  description: `Reliable group travel for Newark and surrounding areas. Professional group travel coordination for schools, churches, sports teams, and organizations. Available 24/7 at 833-874-1019.`,
  keywords: [
    `group-travel Newark`,
    `Newark group travel`,
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-newark/group-travel`,
  },
  openGraph: {
    title: `Group Travel in Newark | Next Trip Anywhere`,
    description: `Professional group travel for Newark residents. Professional group travel coordination for schools, churches, sports teams, and organizations.`,
    url: `https://nexttripanywhere.com/travel-from-newark/group-travel`,
    type: 'website',
    locale: 'en_US',
...
export default function NewarkGroupTravelPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Your trusted group travel provider in Newark and Essex County.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Group Travel for Newark Residents</h2>
            <div className="prose max-w-none">
              <p>
                Your trusted group travel provider in Newark and Essex County. With a population of
                311,549, Newark residents trust Next Trip Anywhere for reliable group travel
                services.
              </p>
