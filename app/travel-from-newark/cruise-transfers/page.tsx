/**
 * Newark Cruise Transfers Service Page
...
export const metadata: Metadata = {
  title: `Cruise Transfers in Newark, NJ | Next Trip Anywhere`,
  description: `Direct transfers to Manhattan, Brooklyn, and Cape Liberty cruise terminals with luggage assistance. Serving Newark and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `cruise-transfers Newark`,
    `Newark cruise transfers`,
    ...[
      'cruise transfers',
      'port transportation',
      'cruise terminal',
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-newark/cruise-transfers`,
  },
  openGraph: {
    title: `Cruise Transfers in Newark | Next Trip Anywhere`,
    description: `Professional cruise transfers for Newark residents. Direct transfers to Manhattan, Brooklyn, and Cape Liberty cruise terminals with luggage assistance.`,
    url: `https://nexttripanywhere.com/travel-from-newark/cruise-transfers`,
    type: 'website',
    locale: 'en_US',
...
export default function NewarkCruiseTransfersPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Reliable cruise port transfers from Newark to Manhattan, Brooklyn, and Cape Liberty terminals.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Cruise Transfers for Newark Residents</h2>
            <div className="prose max-w-none">
              <p>
                Reliable cruise port transfers from Newark to Manhattan, Brooklyn, and Cape Liberty
                terminals. With a population of 311,549, Newark residents trust Next Trip Anywhere
                for reliable cruise transfers services.
              </p>
