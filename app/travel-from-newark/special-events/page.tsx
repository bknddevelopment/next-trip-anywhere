/**
 * Newark Special Events Service Page
...
export const metadata: Metadata = {
  title: `Special Events in Newark, NJ | Next Trip Anywhere`,
  description: `Transportation for concerts, sporting events, proms, and special occasions throughout the tri-state area. Serving Newark and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `special-events Newark`,
    `Newark special events`,
    ...['special events', 'concert transportation', 'sports events', 'prom limo', 'event shuttle'],
    `Newark NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-newark/special-events`,
  },
  openGraph: {
    title: `Special Events in Newark | Next Trip Anywhere`,
    description: `Professional special events for Newark residents. Transportation for concerts, sporting events, proms, and special occasions throughout the tri-state area.`,
    url: `https://nexttripanywhere.com/travel-from-newark/special-events`,
    type: 'website',
    locale: 'en_US',
...
export default function NewarkSpecialEventsPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Special event transportation from Newark to concerts, sports events, and celebrations.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Special Events for Newark Residents</h2>
            <div className="prose max-w-none">
              <p>
                Special event transportation from Newark to concerts, sports events, and
                celebrations. With a population of 311,549, Newark residents trust Next Trip
