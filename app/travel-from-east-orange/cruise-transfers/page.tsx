/**
 * East Orange Cruise Transfers Service Page
...
export const metadata: Metadata = {
  title: `Cruise Transfers in East Orange, NJ | Next Trip Anywhere`,
  description: `Direct transfers to Manhattan, Brooklyn, and Cape Liberty cruise terminals with luggage assistance. Serving East Orange and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `cruise-transfers East Orange`,
    `East Orange cruise transfers`,
    ...[
      'cruise transfers',
      'port transportation',
      'cruise terminal',
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-east-orange/cruise-transfers`,
  },
  openGraph: {
    title: `Cruise Transfers in East Orange | Next Trip Anywhere`,
    description: `Professional cruise transfers for East Orange residents. Direct transfers to Manhattan, Brooklyn, and Cape Liberty cruise terminals with luggage assistance.`,
    url: `https://nexttripanywhere.com/travel-from-east-orange/cruise-transfers`,
    type: 'website',
    locale: 'en_US',
...
export default function EastOrangeCruiseTransfersPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Reliable cruise port transfers from East Orange to Manhattan, Brooklyn, and Cape Liberty terminals.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Cruise Transfers for East Orange Residents</h2>
            <div className="prose max-w-none">
              <p>
                Reliable cruise port transfers from East Orange to Manhattan, Brooklyn, and Cape
                Liberty terminals. With a population of 69,612, East Orange residents trust Next
