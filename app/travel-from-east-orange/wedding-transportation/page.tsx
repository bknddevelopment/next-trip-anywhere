/**
 * East Orange Wedding Transportation Service Page
...
export const metadata: Metadata = {
  title: `Wedding Transportation in East Orange, NJ | Next Trip Anywhere`,
  description: `Elegant wedding transportation including limousines, party buses, and guest shuttle services. Serving East Orange and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `wedding-transportation East Orange`,
    `East Orange wedding transportation`,
    ...['wedding transportation', 'wedding limo', 'bridal party', 'guest shuttle', 'wedding cars'],
    `East Orange NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-east-orange/wedding-transportation`,
  },
  openGraph: {
    title: `Wedding Transportation in East Orange | Next Trip Anywhere`,
    description: `Professional wedding transportation for East Orange residents. Elegant wedding transportation including limousines, party buses, and guest shuttle services.`,
    url: `https://nexttripanywhere.com/travel-from-east-orange/wedding-transportation`,
    type: 'website',
    locale: 'en_US',
...
export default function EastOrangeWeddingTransportationPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Elegant wedding transportation services for East Orange couples and wedding parties.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">
              Wedding Transportation for East Orange Residents
            </h2>
