/**
 * East Orange Special Events Service Page
...
export const metadata: Metadata = {
  title: `Special Events in East Orange, NJ | Next Trip Anywhere`,
  description: `Transportation for concerts, sporting events, proms, and special occasions throughout the tri-state area. Serving East Orange and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `special-events East Orange`,
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-east-orange/special-events`,
  },
  openGraph: {
    title: `Special Events in East Orange | Next Trip Anywhere`,
    description: `Professional special events for East Orange residents. Transportation for concerts, sporting events, proms, and special occasions throughout the tri-state area.`,
    url: `https://nexttripanywhere.com/travel-from-east-orange/special-events`,
    type: 'website',
    locale: 'en_US',
...
export default function EastOrangeSpecialEventsPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Special event transportation from East Orange to concerts, sports events, and celebrations.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Special Events for East Orange Residents</h2>
            <div className="prose max-w-none">
              <p>
                Special event transportation from East Orange to concerts, sports events, and
                celebrations. With a population of 69,612, East Orange residents trust Next Trip
