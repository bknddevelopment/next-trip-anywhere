/**
 * Caldwell Wine Tours & Day Trips Service Page
...
export const metadata: Metadata = {
  title: `Wine Tours & Day Trips in Caldwell, NJ | Next Trip Anywhere`,
  description: `Guided wine tours to NJ wineries, NYC day trips, and Atlantic City excursions with comfortable transportation. Serving Caldwell and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `wine-tours-day-trips Caldwell`,
    `Caldwell wine tours & day trips`,
    ...['wine tours', 'day trips', 'winery tours', 'NYC tours', 'Atlantic City trips'],
    `Caldwell NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-caldwell/wine-tours-day-trips`,
  },
  openGraph: {
    title: `Wine Tours & Day Trips in Caldwell | Next Trip Anywhere`,
    description: `Professional wine tours & day trips for Caldwell residents. Guided wine tours to NJ wineries, NYC day trips, and Atlantic City excursions with comfortable transportation.`,
    url: `https://nexttripanywhere.com/travel-from-caldwell/wine-tours-day-trips`,
    type: 'website',
    locale: 'en_US',
...
export default function CaldwellWineToursDayTripsPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Wine tours and day trips from Caldwell to NJ wineries and NYC attractions.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">
              Wine Tours & Day Trips for Caldwell Residents
            </h2>
            <div className="prose max-w-none">
              <p>
                Wine tours and day trips from Caldwell to NJ wineries and NYC attractions. With a
                population of 9,027, Caldwell residents trust Next Trip Anywhere for reliable wine
