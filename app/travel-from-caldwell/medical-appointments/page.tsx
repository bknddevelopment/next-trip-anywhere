/**
 * Caldwell Medical Appointments Service Page
...
export const metadata: Metadata = {
  title: `Medical Appointments in Caldwell, NJ | Next Trip Anywhere`,
  description: `Safe, reliable transportation to medical appointments, treatments, and hospital visits. Serving Caldwell and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `medical-appointments Caldwell`,
    `Caldwell medical appointments`,
    ...[
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-caldwell/medical-appointments`,
  },
  openGraph: {
    title: `Medical Appointments in Caldwell | Next Trip Anywhere`,
    description: `Professional medical appointments for Caldwell residents. Safe, reliable transportation to medical appointments, treatments, and hospital visits.`,
    url: `https://nexttripanywhere.com/travel-from-caldwell/medical-appointments`,
    type: 'website',
    locale: 'en_US',
...
export default function CaldwellMedicalAppointmentsPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Safe medical transportation for Caldwell residents to appointments and treatments.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Medical Appointments for Caldwell Residents</h2>
            <div className="prose max-w-none">
              <p>
                Safe medical transportation for Caldwell residents to appointments and treatments.
