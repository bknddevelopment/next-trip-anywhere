/**
 * Nutley Corporate Travel Service Page
...
export const metadata: Metadata = {
  title: `Corporate Travel in Nutley, NJ | Next Trip Anywhere`,
  description: `Reliable corporate travel for Nutley and surrounding areas. Comprehensive business travel solutions including flight booking, hotel arrangements, and expense management. Available 24/7 at 833-874-1019.`,
  keywords: [
    `corporate-travel Nutley`,
    `Nutley corporate travel`,
    ...[
      'corporate travel',
      'business travel',
      'company trips',
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-nutley/corporate-travel`,
  },
  openGraph: {
    title: `Corporate Travel in Nutley | Next Trip Anywhere`,
    description: `Professional corporate travel for Nutley residents. Comprehensive business travel solutions including flight booking, hotel arrangements, and expense management.`,
    url: `https://nexttripanywhere.com/travel-from-nutley/corporate-travel`,
    type: 'website',
    locale: 'en_US',
...
export default function NutleyCorporateTravelPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Professional corporate travel services tailored for Nutley residents and businesses.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Corporate Travel for Nutley Residents</h2>
            <div className="prose max-w-none">
              <p>
                Professional corporate travel services tailored for Nutley residents and businesses.
                With a population of 30,143, Nutley residents trust Next Trip Anywhere for reliable
