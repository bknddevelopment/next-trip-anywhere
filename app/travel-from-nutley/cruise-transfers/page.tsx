/**
 * Nutley Cruise Transfers Service Page
...
export const metadata: Metadata = {
  title: `Cruise Transfers in Nutley, NJ | Next Trip Anywhere`,
  description: `Reliable cruise transfers for Nutley and surrounding areas. Direct transfers to Manhattan, Brooklyn, and Cape Liberty cruise terminals with luggage assistance. Available 24/7 at 833-874-1019.`,
  keywords: [
    `cruise-transfers Nutley`,
    `Nutley cruise transfers`,
    ...[
      'cruise transfers',
      'port transportation',
      'cruise terminal',
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-nutley/cruise-transfers`,
  },
  openGraph: {
    title: `Cruise Transfers in Nutley | Next Trip Anywhere`,
    description: `Professional cruise transfers for Nutley residents. Direct transfers to Manhattan, Brooklyn, and Cape Liberty cruise terminals with luggage assistance.`,
    url: `https://nexttripanywhere.com/travel-from-nutley/cruise-transfers`,
    type: 'website',
    locale: 'en_US',
...
export default function NutleyCruiseTransfersPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Professional cruise transfers services tailored for Nutley residents and businesses.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Cruise Transfers for Nutley Residents</h2>
