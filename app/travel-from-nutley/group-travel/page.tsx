/**
 * Nutley Group Travel Service Page
...
export const metadata: Metadata = {
  title: `Group Travel in Nutley, NJ | Next Trip Anywhere`,
  description: `Reliable group travel for Nutley and surrounding areas. Professional group travel coordination for schools, churches, sports teams, and organizations. Available 24/7 at 833-874-1019.`,
  keywords: [
    `group-travel Nutley`,
    `Nutley group travel`,
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-nutley/group-travel`,
  },
  openGraph: {
    title: `Group Travel in Nutley | Next Trip Anywhere`,
    description: `Professional group travel for Nutley residents. Professional group travel coordination for schools, churches, sports teams, and organizations.`,
    url: `https://nexttripanywhere.com/travel-from-nutley/group-travel`,
    type: 'website',
    locale: 'en_US',
...
export default function NutleyGroupTravelPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Your trusted group travel provider in Nutley and Essex County.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Group Travel for Nutley Residents</h2>
            <div className="prose max-w-none">
              <p>
                Your trusted group travel provider in Nutley and Essex County. With a population of
                30,143, Nutley residents trust Next Trip Anywhere for reliable group travel
                services.
              </p>
