/**
 * Nutley Special Events Service Page
...
export const metadata: Metadata = {
  title: `Special Events in Nutley, NJ | Next Trip Anywhere`,
  description: `Reliable special events for Nutley and surrounding areas. Transportation for concerts, sporting events, proms, and special occasions throughout the tri-state area. Available 24/7 at 833-874-1019.`,
  keywords: [
    `special-events Nutley`,
    `Nutley special events`,
    ...['special events', 'concert transportation', 'sports events', 'prom limo', 'event shuttle'],
    `Nutley NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-nutley/special-events`,
  },
  openGraph: {
    title: `Special Events in Nutley | Next Trip Anywhere`,
    description: `Professional special events for Nutley residents. Transportation for concerts, sporting events, proms, and special occasions throughout the tri-state area.`,
    url: `https://nexttripanywhere.com/travel-from-nutley/special-events`,
    type: 'website',
    locale: 'en_US',
...
export default function NutleySpecialEventsPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Serving Nutley with premium special events solutions since 2010.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Special Events for Nutley Residents</h2>
            <div className="prose max-w-none">
              <p>
                Serving Nutley with premium special events solutions since 2010. With a population
                of 30,143, Nutley residents trust Next Trip Anywhere for reliable special events
                services.
              </p>
