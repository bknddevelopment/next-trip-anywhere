/**
 * Nutley Wedding Transportation Service Page
...
export const metadata: Metadata = {
  title: `Wedding Transportation in Nutley, NJ | Next Trip Anywhere`,
  description: `Reliable wedding transportation for Nutley and surrounding areas. Elegant wedding transportation including limousines, party buses, and guest shuttle services. Available 24/7 at 833-874-1019.`,
  keywords: [
    `wedding-transportation Nutley`,
    `Nutley wedding transportation`,
    ...['wedding transportation', 'wedding limo', 'bridal party', 'guest shuttle', 'wedding cars'],
    `Nutley NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-nutley/wedding-transportation`,
  },
  openGraph: {
    title: `Wedding Transportation in Nutley | Next Trip Anywhere`,
    description: `Professional wedding transportation for Nutley residents. Elegant wedding transportation including limousines, party buses, and guest shuttle services.`,
    url: `https://nexttripanywhere.com/travel-from-nutley/wedding-transportation`,
    type: 'website',
    locale: 'en_US',
...
export default function NutleyWeddingTransportationPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Professional wedding transportation services tailored for Nutley residents and businesses.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Wedding Transportation for Nutley Residents</h2>
            <div className="prose max-w-none">
              <p>
                Professional wedding transportation services tailored for Nutley residents and
