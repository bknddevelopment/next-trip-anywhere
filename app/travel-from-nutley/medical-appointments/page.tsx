/**
 * Nutley Medical Appointments Service Page
...
export const metadata: Metadata = {
  title: `Medical Appointments in Nutley, NJ | Next Trip Anywhere`,
  description: `Reliable medical appointments for Nutley and surrounding areas. Safe, reliable transportation to medical appointments, treatments, and hospital visits. Available 24/7 at 833-874-1019.`,
  keywords: [
    `medical-appointments Nutley`,
    `Nutley medical appointments`,
    ...[
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-nutley/medical-appointments`,
  },
  openGraph: {
    title: `Medical Appointments in Nutley | Next Trip Anywhere`,
    description: `Professional medical appointments for Nutley residents. Safe, reliable transportation to medical appointments, treatments, and hospital visits.`,
    url: `https://nexttripanywhere.com/travel-from-nutley/medical-appointments`,
    type: 'website',
    locale: 'en_US',
...
export default function NutleyMedicalAppointmentsPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Serving Nutley with premium medical appointments solutions since 2010.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Medical Appointments for Nutley Residents</h2>
            <div className="prose max-w-none">
              <p>
                Serving Nutley with premium medical appointments solutions since 2010. With a
                population of 30,143, Nutley residents trust Next Trip Anywhere for reliable medical
