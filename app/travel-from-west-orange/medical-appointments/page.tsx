/**
 * West Orange Medical Appointments Service Page
...
export const metadata: Metadata = {
  title: `Medical Appointments in West Orange, NJ | Next Trip Anywhere`,
  description: `Safe, reliable transportation to medical appointments, treatments, and hospital visits. Serving West Orange and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `medical-appointments West Orange`,
    `West Orange medical appointments`,
    ...[
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-west-orange/medical-appointments`,
  },
  openGraph: {
    title: `Medical Appointments in West Orange | Next Trip Anywhere`,
    description: `Professional medical appointments for West Orange residents. Safe, reliable transportation to medical appointments, treatments, and hospital visits.`,
    url: `https://nexttripanywhere.com/travel-from-west-orange/medical-appointments`,
    type: 'website',
    locale: 'en_US',
...
export default function WestOrangeMedicalAppointmentsPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Safe medical transportation for West Orange residents to appointments and treatments.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">
              Medical Appointments for West Orange Residents
            </h2>
            <div className="prose max-w-none">
              <p>
                Safe medical transportation for West Orange residents to appointments and
                treatments. With a population of 48,843, West Orange residents trust Next Trip
