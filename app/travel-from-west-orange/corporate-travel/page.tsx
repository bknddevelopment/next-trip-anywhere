/**
 * West Orange Corporate Travel Service Page
...
export const metadata: Metadata = {
  title: `Corporate Travel in West Orange, NJ | Next Trip Anywhere`,
  description: `Comprehensive business travel solutions including flight booking, hotel arrangements, and expense management. Serving West Orange and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `corporate-travel West Orange`,
    `West Orange corporate travel`,
    ...[
      'corporate travel',
      'business travel',
      'company trips',
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-west-orange/corporate-travel`,
  },
  openGraph: {
    title: `Corporate Travel in West Orange | Next Trip Anywhere`,
    description: `Professional corporate travel for West Orange residents. Comprehensive business travel solutions including flight booking, hotel arrangements, and expense management.`,
    url: `https://nexttripanywhere.com/travel-from-west-orange/corporate-travel`,
    type: 'website',
    locale: 'en_US',
...
export default function WestOrangeCorporateTravelPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Professional corporate travel services for West Orange businesses and executives.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Corporate Travel for West Orange Residents</h2>
            <div className="prose max-w-none">
              <p>
                Professional corporate travel services for West Orange businesses and executives.
