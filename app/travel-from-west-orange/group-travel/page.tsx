/**
 * West Orange Group Travel Service Page
...
export const metadata: Metadata = {
  title: `Group Travel in West Orange, NJ | Next Trip Anywhere`,
  description: `Professional group travel services for West Orange residents. Professional group travel coordination for schools, churches, sports teams, and organizations. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `group-travel West Orange`,
    `West Orange group travel`,
    ...['group travel', 'organization trips', 'school travel', 'church groups', 'sports teams'],
    `West Orange NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-west-orange/group-travel`,
  },
  openGraph: {
    title: `Group Travel in West Orange | Next Trip Anywhere`,
    description: `Professional group travel for West Orange residents. Professional group travel coordination for schools, churches, sports teams, and organizations.`,
    url: `https://nexttripanywhere.com/travel-from-west-orange/group-travel`,
    type: 'website',
    locale: 'en_US',
...
export default function WestOrangeGroupTravelPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Professional group travel services tailored for West Orange residents and businesses.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Group Travel for West Orange Residents</h2>
            <div className="prose max-w-none">
              <p>
                Professional group travel services tailored for West Orange residents and
                businesses. With a population of 48,843, West Orange residents trust Next Trip
