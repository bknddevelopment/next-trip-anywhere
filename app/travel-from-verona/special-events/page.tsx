/**
 * Verona Special Events Service Page
...
export const metadata: Metadata = {
  title: `Special Events in Verona, NJ | Next Trip Anywhere`,
  description: `Special Events in Verona, NJ - Next Trip Anywhere provides transportation for concerts, sporting events, proms, and special occasions throughout the tri-state area. Serving Essex County with excellence.`,
  keywords: [
    `special-events Verona`,
    `Verona special events`,
    ...['special events', 'concert transportation', 'sports events', 'prom limo', 'event shuttle'],
    `Verona NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-verona/special-events`,
  },
  openGraph: {
    title: `Special Events in Verona | Next Trip Anywhere`,
    description: `Professional special events for Verona residents. Transportation for concerts, sporting events, proms, and special occasions throughout the tri-state area.`,
    url: `https://nexttripanywhere.com/travel-from-verona/special-events`,
    type: 'website',
    locale: 'en_US',
...
export default function VeronaSpecialEventsPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Professional special events services tailored for Verona residents and businesses.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Special Events for Verona Residents</h2>
            <div className="prose max-w-none">
              <p>
                Professional special events services tailored for Verona residents and businesses.
                With a population of 14,572, Verona residents trust Next Trip Anywhere for reliable
