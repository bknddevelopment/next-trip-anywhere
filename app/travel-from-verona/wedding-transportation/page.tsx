/**
 * Verona Wedding Transportation Service Page
...
export const metadata: Metadata = {
  title: `Wedding Transportation in Verona, NJ | Next Trip Anywhere`,
  description: `Wedding Transportation in Verona, NJ - Next Trip Anywhere provides elegant wedding transportation including limousines, party buses, and guest shuttle services. Serving Essex County with excellence.`,
  keywords: [
    `wedding-transportation Verona`,
    `Verona wedding transportation`,
    ...['wedding transportation', 'wedding limo', 'bridal party', 'guest shuttle', 'wedding cars'],
    `Verona NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-verona/wedding-transportation`,
  },
  openGraph: {
    title: `Wedding Transportation in Verona | Next Trip Anywhere`,
    description: `Professional wedding transportation for Verona residents. Elegant wedding transportation including limousines, party buses, and guest shuttle services.`,
    url: `https://nexttripanywhere.com/travel-from-verona/wedding-transportation`,
    type: 'website',
    locale: 'en_US',
...
export default function VeronaWeddingTransportationPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Your trusted wedding transportation provider in Verona and Essex County.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Wedding Transportation for Verona Residents</h2>
            <div className="prose max-w-none">
              <p>
                Your trusted wedding transportation provider in Verona and Essex County. With a
                population of 14,572, Verona residents trust Next Trip Anywhere for reliable wedding
