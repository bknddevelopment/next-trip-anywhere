/**
 * Verona Group Travel Service Page
...
export const metadata: Metadata = {
  title: `Group Travel in Verona, NJ | Next Trip Anywhere`,
  description: `Group Travel in Verona, NJ - Next Trip Anywhere provides professional group travel coordination for schools, churches, sports teams, and organizations. Serving Essex County with excellence.`,
  keywords: [
    `group-travel Verona`,
    `Verona group travel`,
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-verona/group-travel`,
  },
  openGraph: {
    title: `Group Travel in Verona | Next Trip Anywhere`,
    description: `Professional group travel for Verona residents. Professional group travel coordination for schools, churches, sports teams, and organizations.`,
    url: `https://nexttripanywhere.com/travel-from-verona/group-travel`,
    type: 'website',
    locale: 'en_US',
...
export default function VeronaGroupTravelPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Serving Verona with premium group travel solutions since 2010.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Group Travel for Verona Residents</h2>
            <div className="prose max-w-none">
              <p>
                Serving Verona with premium group travel solutions since 2010. With a population of
                14,572, Verona residents trust Next Trip Anywhere for reliable group travel
                services.
              </p>
