/**
 * Bloomfield Medical Appointments Service Page
...
export const metadata: Metadata = {
  title: `Medical Appointments in Bloomfield, NJ | Next Trip Anywhere`,
  description: `Reliable medical appointments for Bloomfield and surrounding areas. Safe, reliable transportation to medical appointments, treatments, and hospital visits. Available 24/7 at 833-874-1019.`,
  keywords: [
    `medical-appointments Bloomfield`,
    `Bloomfield medical appointments`,
    ...[
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-bloomfield/medical-appointments`,
  },
  openGraph: {
    title: `Medical Appointments in Bloomfield | Next Trip Anywhere`,
    description: `Professional medical appointments for Bloomfield residents. Safe, reliable transportation to medical appointments, treatments, and hospital visits.`,
    url: `https://nexttripanywhere.com/travel-from-bloomfield/medical-appointments`,
    type: 'website',
    locale: 'en_US',
...
export default function BloomfieldMedicalAppointmentsPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Serving Bloomfield with premium medical appointments solutions since 2010.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">
              Medical Appointments for Bloomfield Residents
            </h2>
            <div className="prose max-w-none">
              <p>
                Serving Bloomfield with premium medical appointments solutions since 2010. With a
