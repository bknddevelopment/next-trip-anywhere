/**
 * Irvington Wedding Transportation Service Page
...
export const metadata: Metadata = {
  title: `Wedding Transportation in Irvington, NJ | Next Trip Anywhere`,
  description: `Elegant wedding transportation including limousines, party buses, and guest shuttle services. Serving Irvington and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `wedding-transportation Irvington`,
    `Irvington wedding transportation`,
    ...['wedding transportation', 'wedding limo', 'bridal party', 'guest shuttle', 'wedding cars'],
    `Irvington NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-irvington/wedding-transportation`,
  },
  openGraph: {
    title: `Wedding Transportation in Irvington | Next Trip Anywhere`,
    description: `Professional wedding transportation for Irvington residents. Elegant wedding transportation including limousines, party buses, and guest shuttle services.`,
    url: `https://nexttripanywhere.com/travel-from-irvington/wedding-transportation`,
    type: 'website',
    locale: 'en_US',
...
export default function IrvingtonWeddingTransportationPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Elegant wedding transportation services for Irvington couples and wedding parties.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">
              Wedding Transportation for Irvington Residents
            </h2>
            <div className="prose max-w-none">
              <p>
                Elegant wedding transportation services for Irvington couples and wedding parties.
                With a population of 61,176, Irvington residents trust Next Trip Anywhere for
