/**
 * Irvington Group Travel Service Page
...
export const metadata: Metadata = {
  title: `Group Travel in Irvington, NJ | Next Trip Anywhere`,
  description: `Professional group travel services for Irvington residents. Professional group travel coordination for schools, churches, sports teams, and organizations. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `group-travel Irvington`,
    `Irvington group travel`,
    ...['group travel', 'organization trips', 'school travel', 'church groups', 'sports teams'],
    `Irvington NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-irvington/group-travel`,
  },
  openGraph: {
    title: `Group Travel in Irvington | Next Trip Anywhere`,
    description: `Professional group travel for Irvington residents. Professional group travel coordination for schools, churches, sports teams, and organizations.`,
    url: `https://nexttripanywhere.com/travel-from-irvington/group-travel`,
    type: 'website',
    locale: 'en_US',
...
export default function IrvingtonGroupTravelPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Professional group travel services tailored for Irvington residents and businesses.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Group Travel for Irvington Residents</h2>
