/**
 * Orange Medical Appointments Service Page
...
export const metadata: Metadata = {
  title: `Medical Appointments in Orange, NJ | Next Trip Anywhere`,
  description: `Safe, reliable transportation to medical appointments, treatments, and hospital visits. Serving Orange and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `medical-appointments Orange`,
    `Orange medical appointments`,
    ...[
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-orange/medical-appointments`,
  },
  openGraph: {
    title: `Medical Appointments in Orange | Next Trip Anywhere`,
    description: `Professional medical appointments for Orange residents. Safe, reliable transportation to medical appointments, treatments, and hospital visits.`,
    url: `https://nexttripanywhere.com/travel-from-orange/medical-appointments`,
    type: 'website',
    locale: 'en_US',
...
export default function OrangeMedicalAppointmentsPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Safe medical transportation for Orange residents to appointments and treatments.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Medical Appointments for Orange Residents</h2>
            <div className="prose max-w-none">
              <p>
                Safe medical transportation for Orange residents to appointments and treatments.
                With a population of 34,447, Orange residents trust Next Trip Anywhere for reliable
