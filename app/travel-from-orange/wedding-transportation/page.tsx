/**
 * Orange Wedding Transportation Service Page
...
export const metadata: Metadata = {
  title: `Wedding Transportation in Orange, NJ | Next Trip Anywhere`,
  description: `Elegant wedding transportation including limousines, party buses, and guest shuttle services. Serving Orange and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `wedding-transportation Orange`,
    `Orange wedding transportation`,
    ...['wedding transportation', 'wedding limo', 'bridal party', 'guest shuttle', 'wedding cars'],
    `Orange NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-orange/wedding-transportation`,
  },
  openGraph: {
    title: `Wedding Transportation in Orange | Next Trip Anywhere`,
    description: `Professional wedding transportation for Orange residents. Elegant wedding transportation including limousines, party buses, and guest shuttle services.`,
    url: `https://nexttripanywhere.com/travel-from-orange/wedding-transportation`,
    type: 'website',
    locale: 'en_US',
...
export default function OrangeWeddingTransportationPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Elegant wedding transportation services for Orange couples and wedding parties.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Wedding Transportation for Orange Residents</h2>
            <div className="prose max-w-none">
              <p>
                Elegant wedding transportation services for Orange couples and wedding parties. With
                a population of 34,447, Orange residents trust Next Trip Anywhere for reliable
