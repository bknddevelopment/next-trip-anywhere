/**
 * Orange Group Travel Service Page
...
export const metadata: Metadata = {
  title: `Group Travel in Orange, NJ | Next Trip Anywhere`,
  description: `Professional group travel coordination for schools, churches, sports teams, and organizations. Serving Orange and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `group-travel Orange`,
    `Orange group travel`,
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-orange/group-travel`,
  },
  openGraph: {
    title: `Group Travel in Orange | Next Trip Anywhere`,
    description: `Professional group travel for Orange residents. Professional group travel coordination for schools, churches, sports teams, and organizations.`,
    url: `https://nexttripanywhere.com/travel-from-orange/group-travel`,
    type: 'website',
    locale: 'en_US',
...
export default function OrangeGroupTravelPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Professional group travel coordination for Orange organizations, schools, and churches.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Group Travel for Orange Residents</h2>
            <div className="prose max-w-none">
              <p>
                Professional group travel coordination for Orange organizations, schools, and
                churches. With a population of 34,447, Orange residents trust Next Trip Anywhere for
                reliable group travel services.
              </p>
