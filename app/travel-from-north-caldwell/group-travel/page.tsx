/**
 * North Caldwell Group Travel Service Page
...
export const metadata: Metadata = {
  title: `Group Travel in North Caldwell, NJ | Next Trip Anywhere`,
  description: `Group Travel in North Caldwell, NJ - Next Trip Anywhere provides professional group travel coordination for schools, churches, sports teams, and organizations. Serving Essex County with excellence.`,
  keywords: [
    `group-travel North Caldwell`,
    `North Caldwell group travel`,
    ...['group travel', 'organization trips', 'school travel', 'church groups', 'sports teams'],
    `North Caldwell NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-north-caldwell/group-travel`,
  },
  openGraph: {
    title: `Group Travel in North Caldwell | Next Trip Anywhere`,
    description: `Professional group travel for North Caldwell residents. Professional group travel coordination for schools, churches, sports teams, and organizations.`,
    url: `https://nexttripanywhere.com/travel-from-north-caldwell/group-travel`,
    type: 'website',
    locale: 'en_US',
...
export default function NorthCaldwellGroupTravelPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Serving North Caldwell with premium group travel solutions since 2010.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Group Travel for North Caldwell Residents</h2>
            <div className="prose max-w-none">
              <p>
                Serving North Caldwell with premium group travel solutions since 2010. With a
