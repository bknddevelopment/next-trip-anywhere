/**
 * North Caldwell Special Events Service Page
...
export const metadata: Metadata = {
  title: `Special Events in North Caldwell, NJ | Next Trip Anywhere`,
  description: `Special Events in North Caldwell, NJ - Next Trip Anywhere provides transportation for concerts, sporting events, proms, and special occasions throughout the tri-state area. Serving Essex County with excellence.`,
  keywords: [
    `special-events North Caldwell`,
    `North Caldwell special events`,
    ...['special events', 'concert transportation', 'sports events', 'prom limo', 'event shuttle'],
    `North Caldwell NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-north-caldwell/special-events`,
  },
  openGraph: {
    title: `Special Events in North Caldwell | Next Trip Anywhere`,
    description: `Professional special events for North Caldwell residents. Transportation for concerts, sporting events, proms, and special occasions throughout the tri-state area.`,
    url: `https://nexttripanywhere.com/travel-from-north-caldwell/special-events`,
    type: 'website',
    locale: 'en_US',
...
export default function NorthCaldwellSpecialEventsPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Professional special events services tailored for North Caldwell residents and businesses.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Special Events for North Caldwell Residents</h2>
            <div className="prose max-w-none">
              <p>
                Professional special events services tailored for North Caldwell residents and
