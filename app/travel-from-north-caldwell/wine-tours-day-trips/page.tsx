/**
 * North Caldwell Wine Tours & Day Trips Service Page
...
export const metadata: Metadata = {
  title: `Wine Tours & Day Trips in North Caldwell, NJ | Next Trip Anywhere`,
  description: `Wine Tours & Day Trips in North Caldwell, NJ - Next Trip Anywhere provides guided wine tours to nj wineries, nyc day trips, and atlantic city excursions with comfortable transportation. Serving Essex County with excellence.`,
  keywords: [
    `wine-tours-day-trips North Caldwell`,
    `North Caldwell wine tours & day trips`,
    ...['wine tours', 'day trips', 'winery tours', 'NYC tours', 'Atlantic City trips'],
    `North Caldwell NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-north-caldwell/wine-tours-day-trips`,
  },
  openGraph: {
    title: `Wine Tours & Day Trips in North Caldwell | Next Trip Anywhere`,
    description: `Professional wine tours & day trips for North Caldwell residents. Guided wine tours to NJ wineries, NYC day trips, and Atlantic City excursions with comfortable transportation.`,
    url: `https://nexttripanywhere.com/travel-from-north-caldwell/wine-tours-day-trips`,
    type: 'website',
    locale: 'en_US',
...
export default function NorthCaldwellWineToursDayTripsPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Your trusted wine tours & day trips provider in North Caldwell and Essex County.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">
              Wine Tours & Day Trips for North Caldwell Residents
            </h2>
            <div className="prose max-w-none">
              <p>
                Your trusted wine tours & day trips provider in North Caldwell and Essex County.
                With a population of 7,375, North Caldwell residents trust Next Trip Anywhere for
