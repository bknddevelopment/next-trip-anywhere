/**
 * Glen Ridge Corporate Travel Service Page
...
export const metadata: Metadata = {
  title: `Corporate Travel in Glen Ridge, NJ | Next Trip Anywhere`,
  description: `Corporate Travel in Glen Ridge, NJ - Next Trip Anywhere provides comprehensive business travel solutions including flight booking, hotel arrangements, and expense management. Serving Essex County with excellence.`,
  keywords: [
    `corporate-travel Glen Ridge`,
    `Glen Ridge corporate travel`,
    ...[
      'corporate travel',
      'business travel',
      'company trips',
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-glen-ridge/corporate-travel`,
  },
  openGraph: {
    title: `Corporate Travel in Glen Ridge | Next Trip Anywhere`,
    description: `Professional corporate travel for Glen Ridge residents. Comprehensive business travel solutions including flight booking, hotel arrangements, and expense management.`,
    url: `https://nexttripanywhere.com/travel-from-glen-ridge/corporate-travel`,
    type: 'website',
    locale: 'en_US',
...
export default function GlenRidgeCorporateTravelPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Your trusted corporate travel provider in Glen Ridge and Essex County.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Corporate Travel for Glen Ridge Residents</h2>
            <div className="prose max-w-none">
              <p>
                Your trusted corporate travel provider in Glen Ridge and Essex County. With a
