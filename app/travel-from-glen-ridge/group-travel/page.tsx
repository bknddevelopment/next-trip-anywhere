/**
 * Glen Ridge Group Travel Service Page
...
export const metadata: Metadata = {
  title: `Group Travel in Glen Ridge, NJ | Next Trip Anywhere`,
  description: `Group Travel in Glen Ridge, NJ - Next Trip Anywhere provides professional group travel coordination for schools, churches, sports teams, and organizations. Serving Essex County with excellence.`,
  keywords: [
    `group-travel Glen Ridge`,
    `Glen Ridge group travel`,
    ...['group travel', 'organization trips', 'school travel', 'church groups', 'sports teams'],
    `Glen Ridge NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-glen-ridge/group-travel`,
  },
  openGraph: {
    title: `Group Travel in Glen Ridge | Next Trip Anywhere`,
    description: `Professional group travel for Glen Ridge residents. Professional group travel coordination for schools, churches, sports teams, and organizations.`,
    url: `https://nexttripanywhere.com/travel-from-glen-ridge/group-travel`,
    type: 'website',
    locale: 'en_US',
...
export default function GlenRidgeGroupTravelPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Serving Glen Ridge with premium group travel solutions since 2010.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Group Travel for Glen Ridge Residents</h2>
            <div className="prose max-w-none">
              <p>
                Serving Glen Ridge with premium group travel solutions since 2010. With a population
                of 7,852, Glen Ridge residents trust Next Trip Anywhere for reliable group travel
                services.
              </p>
