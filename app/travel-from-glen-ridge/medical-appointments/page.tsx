/**
 * Glen Ridge Medical Appointments Service Page
...
export const metadata: Metadata = {
  title: `Medical Appointments in Glen Ridge, NJ | Next Trip Anywhere`,
  description: `Medical Appointments in Glen Ridge, NJ - Next Trip Anywhere provides safe, reliable transportation to medical appointments, treatments, and hospital visits. Serving Essex County with excellence.`,
  keywords: [
    `medical-appointments Glen Ridge`,
    `Glen Ridge medical appointments`,
    ...[
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-glen-ridge/medical-appointments`,
  },
  openGraph: {
    title: `Medical Appointments in Glen Ridge | Next Trip Anywhere`,
    description: `Professional medical appointments for Glen Ridge residents. Safe, reliable transportation to medical appointments, treatments, and hospital visits.`,
    url: `https://nexttripanywhere.com/travel-from-glen-ridge/medical-appointments`,
    type: 'website',
    locale: 'en_US',
...
export default function GlenRidgeMedicalAppointmentsPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Professional medical appointments services tailored for Glen Ridge residents and businesses.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">
              Medical Appointments for Glen Ridge Residents
            </h2>
            <div className="prose max-w-none">
              <p>
                Professional medical appointments services tailored for Glen Ridge residents and
