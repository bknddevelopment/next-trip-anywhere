/**
 * Roseland Wine Tours & Day Trips Service Page
...
export const metadata: Metadata = {
  title: `Wine Tours & Day Trips in Roseland, NJ | Next Trip Anywhere`,
  description: `Reliable wine tours & day trips for Roseland and surrounding areas. Guided wine tours to NJ wineries, NYC day trips, and Atlantic City excursions with comfortable transportation. Available 24/7 at 833-874-1019.`,
  keywords: [
    `wine-tours-day-trips Roseland`,
    `Roseland wine tours & day trips`,
    ...['wine tours', 'day trips', 'winery tours', 'NYC tours', 'Atlantic City trips'],
    `Roseland NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-roseland/wine-tours-day-trips`,
  },
  openGraph: {
    title: `Wine Tours & Day Trips in Roseland | Next Trip Anywhere`,
    description: `Professional wine tours & day trips for Roseland residents. Guided wine tours to NJ wineries, NYC day trips, and Atlantic City excursions with comfortable transportation.`,
    url: `https://nexttripanywhere.com/travel-from-roseland/wine-tours-day-trips`,
    type: 'website',
    locale: 'en_US',
...
export default function RoselandWineToursDayTripsPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Professional wine tours & day trips services tailored for Roseland residents and businesses.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">
              Wine Tours & Day Trips for Roseland Residents
            </h2>
            <div className="prose max-w-none">
              <p>
                Professional wine tours & day trips services tailored for Roseland residents and
