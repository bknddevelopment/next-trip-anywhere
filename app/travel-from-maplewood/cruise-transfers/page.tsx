/**
 * Maplewood Cruise Transfers Service Page
...
export const metadata: Metadata = {
  title: `Cruise Transfers in Maplewood, NJ | Next Trip Anywhere`,
  description: `Direct transfers to Manhattan, Brooklyn, and Cape Liberty cruise terminals with luggage assistance. Serving Maplewood and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `cruise-transfers Maplewood`,
    `Maplewood cruise transfers`,
    ...[
      'cruise transfers',
      'port transportation',
      'cruise terminal',
  ...
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-maplewood/cruise-transfers`,
  },
  openGraph: {
    title: `Cruise Transfers in Maplewood | Next Trip Anywhere`,
    description: `Professional cruise transfers for Maplewood residents. Direct transfers to Manhattan, Brooklyn, and Cape Liberty cruise terminals with luggage assistance.`,
    url: `https://nexttripanywhere.com/travel-from-maplewood/cruise-transfers`,
    type: 'website',
    locale: 'en_US',
...
export default function MaplewoodCruiseTransfersPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo:
      'Reliable cruise port transfers from Maplewood to Manhattan, Brooklyn, and Cape Liberty terminals.',
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Cruise Transfers for Maplewood Residents</h2>
            <div className="prose max-w-none">
              <p>
                Reliable cruise port transfers from Maplewood to Manhattan, Brooklyn, and Cape
                Liberty terminals. With a population of 25,684, Maplewood residents trust Next Trip
