/**
 * Maplewood Wedding Transportation Service Page
...
export const metadata: Metadata = {
  title: `Wedding Transportation in Maplewood, NJ | Next Trip Anywhere`,
  description: `Elegant wedding transportation including limousines, party buses, and guest shuttle services. Serving Maplewood and surrounding Essex County areas. Call 833-874-1019 for immediate assistance.`,
  keywords: [
    `wedding-transportation Maplewood`,
    `Maplewood wedding transportation`,
    ...['wedding transportation', 'wedding limo', 'bridal party', 'guest shuttle', 'wedding cars'],
    `Maplewood NJ`,
    'Essex County',
  ],
  alternates: {
    canonical: `https://nexttripanywhere.com/travel-from-maplewood/wedding-transportation`,
  },
  openGraph: {
    title: `Wedding Transportation in Maplewood | Next Trip Anywhere`,
    description: `Professional wedding transportation for Maplewood residents. Elegant wedding transportation including limousines, party buses, and guest shuttle services.`,
    url: `https://nexttripanywhere.com/travel-from-maplewood/wedding-transportation`,
    type: 'website',
    locale: 'en_US',
...
export default function MaplewoodWeddingTransportationPage() {
  const serviceData = {
    city: city.name,
    ...
    localInfo: 'Elegant wedding transportation services for Maplewood couples and wedding parties.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">
              Wedding Transportation for Maplewood Residents
            </h2>
            <div className="prose max-w-none">
              <p>
                Elegant wedding transportation services for Maplewood couples and wedding parties.
                With a population of 25,684, Maplewood residents trust Next Trip Anywhere for
